...
class Resource_Cache { 
    ...
    public static $cachePrefix = "tagyourlife_";
    ...
    public static function getInstance() {
        ...
        if (!self::$instance instanceof Zend_Cache_Core) { 
            ...
            $customCacheFile = CONFIGURATION_DIRECTORY . "/cache.xml";
    ...
    public static function load($key, $doNotTestCacheValidity = false) {
        ...
        if($cache = self::getInstance()) {
            ...
            $data = Resource_Tool_Serialize::unserialize($data);
    ...
    public static function storeToCache ($data, $key, $tags = array(), $lifetime = null, $priority = null) {
        ...
        if($cache = self::getInstance()) {
            ...
            $data = Resource_Tool_Serialize::serialize($data);
    ...
    public static function write () {
        ...
        foreach (self::$saveStack as $conf) {
            ...
            try {
				self::storeToCache($conf[0],$conf[1],$conf[2],$conf[3],$conf[4]);
                //forward_static_call_array("storeToCache",$conf);
            } catch (Exception $e) {
